...
<<<<<<< HEAD
            <div className='mt-2'>
                <Collapse
                    ...
                    className='border-none mb-2 py-1 bg-[#f9f9f9]'
                    items={[
                        {
                            key: '1',
                            label: <h3 className='font-medium'>ACTIVITIES</h3>,
                ...
                <Collapse
                    ...
                    items={[
                        {
                            key: '1',
                            label: <h3 className='font-medium'>DIRECTIONS</h3>,
                ...
                <Collapse
                    ...
                    items={[
                        {
                            key: '1',
                            label: <h3 className='font-medium'>INGREDIENTS</h3>,
                ...
                <Collapse
                    ...
                    items={[
                        {
                            key: '1',
                            label: <h3 className='font-medium'>SHIPPING</h3>,
