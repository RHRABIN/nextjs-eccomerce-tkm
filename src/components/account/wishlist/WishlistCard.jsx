    ...
    return (
        <div className='flex items-center justify-between md:w-3/4 my-2'>
            <div className='flex items-center gap-4'>
                <Image src={wishImg} height={720} width={1280} className='h-20 w-20 md:h-32 md:w-32' />

                <div>
                    <Link href='/' className='text-blue-600 text-base md:text-lg font-[300]'>Advanced Snail 92 All In One Cream 100g</Link>
