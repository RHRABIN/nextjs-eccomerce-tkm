                        ...
                        skinCategory?.map(category =>
                            <div key={category?._id} className='px-2 py-10'>
                                <Link href={`/products?subcat=${category?.slug}`} className='relative flex items-center justify-center'>
                                    ...
                                    {
                                        !category?.image && <p className='absolute inset-0 px-2 flex items-center justify-center text-center w-full font-bold uppercase bg-[#00000033] text-[#f1f1f1]'>{category?.title}</p>
                                    }
