        ...
        <div className='bg-secondary'>
            <nav className='container mx-auto text-white'>
                <ul className='flex items-center gap-6 text-sm justify-center'>
                    <li className='border-b-2 border-b-black hover:border-b-2 hover:border-b-primary'><Link href='' className='uppercase'>New</Link></li>
                    {/* sub menu start */}
                    <li className='border-b-2 border-b-secondary hover:border-b-2 relative py-4 group'>
                        ...
                        <ul className='absolute bg-secondary top-[100%] hidden group-hover:block group-hover:border-t group-hover:border-t-gray-500'>
                            <li className='border-b-gray-500 border-b p-2 w-60 flex items-start gap-2 cursor-pointer'>
                            ...
                            <li className='border-b-gray-500 border-b p-2 w-60 relative flex items-start gap-2 cursor-pointer group/sub'>
